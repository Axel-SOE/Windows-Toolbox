...
$Shortcut = $Shell.CreateShortcut("$env:USERPROFILE\Desktop\Windows Toolbox.lnk")

$Shortcut.TargetPath = "wt.exe"
$Shortcut.Arguments  = "powershell.exe -ExecutionPolicy Bypass -File `"$PSScriptRoot\MenuASO.ps1`""
$Shortcut.WorkingDirectory = $PSScriptRoot
$Shortcut.IconLocation = "$PSScriptRoot\assets\toolbox.ico"
$Shortcut.Save()
